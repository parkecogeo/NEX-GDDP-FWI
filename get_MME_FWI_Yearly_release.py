...
def get_Yearly_MME(runtypeid,inputid):
    ...
    ds_stack_P25.FWI_P25.attrs['fullname'] = '25th percentile FWI (Fire Weather Index)'
    ds_stack_P25.FWI_P50.attrs['fullname'] = '50th percentile FWI (Fire Weather Index)'
    ds_stack_P25.FWI_P75.attrs['fullname'] = '75th percentile FWI (Fire Weather Index)'
    ds_stack_P25.FWI_P95.attrs['fullname'] = '95th percentile FWI (Fire Weather Index)'    
    ...
    ds_stack_P25.attrs['frequency'] = '%s'%(Att_Frequency_Y)
    ...
    ds_stack_P25.attrs['tracking_id'] = '%s'%(Att_tracking_id_Y),
    ...
    ds_stack_P50.FWI_P25.attrs['fullname'] = '25th percentile FWI (Fire Weather Index)'
    ds_stack_P50.FWI_P50.attrs['fullname'] = '50th percentile FWI (Fire Weather Index)'
    ds_stack_P50.FWI_P75.attrs['fullname'] = '75th percentile FWI (Fire Weather Index)'
    ds_stack_P50.FWI_P95.attrs['fullname'] = '95th percentile FWI (Fire Weather Index)'   
    ...
    ds_stack_P50.attrs['frequency'] = '%s'%(Att_Frequency_Y)
    ...
    ds_stack_P50.attrs['tracking_id'] = '%s'%(Att_tracking_id_Y),
    ...
    ds_stack_P75.FWI_P25.attrs['fullname'] = '25th percentile FWI (Fire Weather Index)'
    ds_stack_P75.FWI_P50.attrs['fullname'] = '50th percentile FWI (Fire Weather Index)'
    ds_stack_P75.FWI_P75.attrs['fullname'] = '75th percentile FWI (Fire Weather Index)'
    ds_stack_P75.FWI_P95.attrs['fullname'] = '95th percentile FWI (Fire Weather Index)'   
    ...
    ds_stack_P75.attrs['frequency'] = '%s'%(Att_Frequency_Y)
    ...
    ds_stack_P75.attrs['tracking_id'] = '%s'%(Att_tracking_id_Y),
